...
// baseURL centraliza a URL base da API — nunca hardcode URLs no corpo do teste
// Para trocar de ambiente sem alterar o código:
// k6 run tests/login.test.js -e baseURL=http://localhost:3000
export const baseURL = __ENV.baseURL || __ENV.BASE_URL || 'http://localhost:3000';
